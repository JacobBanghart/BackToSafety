...
- [x] App name should be Wandering
- [x] Coloring on buttons should be consistent
- [x] Remove tracking information, was wishful thinking
- [x] Style the landing page for onboarding
- [x] More contrast between header bar and content body
- [x] 911 Dispatch Read-out color in the header has bad constast and 3 colors of purple on the page does not work well
- [x] Formatting on phone numbers with () and `-`
- [x] Emergency readout button says tap to add medical information but you cant from that screen
